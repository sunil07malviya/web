<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ResponseTypeMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.ResponseTypeMaster" %>
...
<head runat="server">
    <title>Response Type Master</title>
...
<body>
     <form id="frmResponseType" runat="server">
     <asp:ScriptManager ID="smfrmResponseType" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Response Type</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updResponseType" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    <td style="width: 25%;">
                                        Response Code<span class="mandatory">&nbsp;*</span>
                                    </td>
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtCode" MaxLength="1" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    <td style="width: 25%;">
                                        Response Type<span class="mandatory">&nbsp;*</span>
                                    </td>
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtType" MaxLength="100" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnResponseType" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgResponseType" runat="server">
                                            <ProgressTemplate>
