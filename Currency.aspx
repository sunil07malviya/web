<%@ Page Language="C#" AutoEventWireup="true" Theme="BlueTheme" CodeFile="Currency.aspx.cs" Inherits="ISPL.CSC.Web.Masters.Currency" %>
...
<body>
    <form id="frmCurrency" runat="server">
    <asp:ScriptManager ID="smCurrency" runat="server">
    </asp:ScriptManager>
    <div class="rounded" style="width:30%">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Currency</span>
                                </h2>
                            </td>
                            <td align="right">
        ...
        <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updCurrency" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                ...
                                <tr>
                                        <td style="width: 25%;">
                                            Sub Currency<span class="mandatory">&nbsp;*</span>
                                        </td>
                                        <td style="width: 75%;">
                                            <asp:TextBox ID="txtSubCurrency" MaxLength="30" Columns="25" runat="server"></asp:TextBox>
                                        </td>
                                </tr>
                               <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnCurrency" runat="server" OnEditButtonClick="Page_EditButton"
