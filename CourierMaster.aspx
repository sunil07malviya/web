<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CourierMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.CourierMaster" %>
...
<body>
    <form id="frmCourier" runat="server">
     <asp:ScriptManager ID="smCourier" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Courier</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updCourier" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtCode" MaxLength="30" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnCourier" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgCourier" runat="server">
                                            <ProgressTemplate>
