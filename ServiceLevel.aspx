<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceLevel.aspx.cs" Theme="BlueTheme" Inherits="ISPL.CSC.Web.Masters.ServiceLevel" %>
                    ...
                    <asp:UpdatePanel ID="updService" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="bcService" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgService" runat="server">
                                            <ProgressTemplate>
