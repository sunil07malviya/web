<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReasonMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.ReasonMaster" %>
...
<body>
    <form id="frmReason" runat="server">
     <asp:ScriptManager ID="smReason" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Reason</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updReason" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtReason" MaxLength="255" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnReason" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgReason" runat="server">
                                            <ProgressTemplate>
