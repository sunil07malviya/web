<%@ Page Language="C#" AutoEventWireup="true" Theme="BlueTheme" CodeFile="Country.aspx.cs" Inherits="ISPL.CSC.Web.Masters.Country" %>
...
<body>
    ...
    <asp:ScriptManager ID="smCountry" runat="server">
    </asp:ScriptManager>
    <div class="rounded" style="width:30%">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Country</span>
                                </h2>
                            </td>
                            <td align="right">
        ...
        <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updCountry" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnCountry" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgCountry" runat="server">
                                            <ProgressTemplate>
