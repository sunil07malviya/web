<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModelMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.ModelMaster" %>
...
<body>
     ...
     <asp:ScriptManager ID="smModel" runat="server">
    </asp:ScriptManager>
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Model</span>
                                </h2>
                            </td>
                            <td align="right">
                    ...
                    <asp:UpdatePanel ID="updModel" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    <td style="width: 25%;">
                                        ShortName <span class="mandatory">&nbsp;*</span>
                                    </td>
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtCode" MaxLength="50" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtDesc" MaxLength="200" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnModel" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgModel" runat="server">
                                            <ProgressTemplate>
