<%@ Page Language="C#" AutoEventWireup="true" Theme="BlueTheme" CodeFile="Branchdetails.aspx.cs" Inherits="ISPL.CSC.Web.Masters.Branchdetails" %>
...
<body>
    <form id="frmBranchdetails" runat="server">
    <asp:ScriptManager ID="smBD" runat="server">
    </asp:ScriptManager>
    <div class="rounded" style="width:55%">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Branch Details</span>
                                </h2>
                            </td>
                            <td align="right">
        ...
        <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updBranchDt" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <table cellpadding="2" border="0" cellspacing="0" style="font-size: 8.25pt" width="100%">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBranchName" MaxLength="100" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvBranchName" runat="server" ErrorMessage="Branch name is required!"
                                            Text="*" ControlToValidate="txtBranchName"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                       Short Name
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBranShortName" MaxLength="100" runat="server"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4">
                                         <uc1:ButtonControl ID="bcBranch" runat="server" OnSubmitButtonClick="bcBranch_SubmitButton"
                                            OnDeleteButtonClick="bcBranch_DeleteButton" OnCancelButtonClick="bcBranch_CancelButton"
                                            OnEditButtonClick="bcBranch_EditButton" />
                                    </td>                                    
                                </tr>
                                <tr>
                                    <td colspan="4" align="center">
                                        <asp:UpdateProgress ID="prgCurrencyMaster" runat="server">
                                            <ProgressTemplate>
