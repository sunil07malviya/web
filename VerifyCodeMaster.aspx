<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerifyCodeMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.VerifyCodeMaster" %>
...
<head id="Head1" runat="server">
    <title>Verify code Masters</title>
...
<body>
   <form id="frmVerifyCode" runat="server">
     <asp:ScriptManager ID="smVerifyCode" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Verify code</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updVerifyCode" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                            <tr>
                                    <td style="width: 25%;">
                                        VerifyGroup ShortName
                                    </td>
                                    <td style="width: 75%;">
                                       <uc1:LOVControl ID="LOVVerifyGroupSN" runat="server" Columns="15" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 25%;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnVerifyCode" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgVerifyCode" runat="server">
                                            <ProgressTemplate>
