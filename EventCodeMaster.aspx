<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EventCodeMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.EventCodeMaster" %>
...
<head runat="server">
    <title>Event Code Masters</title>
...
<body>
     <form id="frmEventCode" runat="server">
     <asp:ScriptManager ID="smfrmfrmEventCode" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Event Codes</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updfrmEventCode" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtValuekey" MaxLength="255" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtValueText" MaxLength="255" Columns="15" runat="server"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtValueType" MaxLength="255" Columns="15" runat="server"></asp:TextBox>
                                       <%-- <asp:RequiredFieldValidator ID="rfvDesc" runat="server" ErrorMessage="Description is required!"
                                            ControlToValidate="txtDesc">*</asp:RequiredFieldValidator>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnEventCode" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgEventCode" runat="server">
                                            <ProgressTemplate>
