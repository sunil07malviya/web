<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ActionMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.ActionMaster" %>
...
<head runat="server">
    <title>Action Code Master</title>
...
<body>
    <form id="frmActionCode" runat="server">
     <asp:ScriptManager ID="smActionCode" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Action Code</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updActionCodes" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    ...
                                    <td style="width: 75%;">
                                        <asp:TextBox ID="txtAction" MaxLength="4" Columns="15" runat="server"></asp:TextBox>
                                        <%--<asp:RequiredFieldValidator ID="rfvAction" runat="server" ErrorMessage="Action is required!"
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnActionCodes" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgActionCodes" runat="server">
                                            <ProgressTemplate>
