<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ServiceLevelMaster.aspx.cs" Inherits="ISPL.CSC.Web.Masters.ServiceLevelMaster" %>
...
<head id="Head1" runat="server">
    <title>Service Level Masters</title>
...
<body>
   <form id="frmServicelevel" runat="server">
     <asp:ScriptManager ID="smServicelevel" runat="server">
    </asp:ScriptManager>
     <div class="rounded" style="width: 500px;">
        <div class="top-outer">
                ...
                <div class="top">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td>
                                <h2>
                                    <span id="lblHeading" runat="server">Sevice Level</span>
                                </h2>
                            </td>
                            <td align="right">
         ...
         <div class="mid-outer">
            <div class="mid-inner">
                <div class="mid">
                    <asp:UpdatePanel ID="updServicelevel" runat="server">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="2" style="font-size: 8.25pt;">
                                <tr>
                                    <td style="width: 25%;">
                                        Service Level Code<span class="mandatory">&nbsp;*</span>
                                    </td>
                                    <td style="width: 75%;">
                                ...
                                <tr>
                                    <td style="width: 25%;">
                                        Service Level Desc<span class="mandatory">&nbsp;*</span>
                                    </td>
                                    <td style="width: 75%;">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <uc1:ButtonControl ID="btnServiceLevelCode" runat="server" OnEditButtonClick="Page_EditButton"
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <asp:UpdateProgress ID="prgServiceLevel" runat="server">
                                            <ProgressTemplate>
